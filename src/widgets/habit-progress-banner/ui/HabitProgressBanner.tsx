      ...
      return (
        <div className={styles.variant2}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <div style={{ fontSize: '15px', fontWeight: 700, color: '#ffffff' }}>{titleText}</div>
              <div style={{ fontSize: '12.5px', color: 'rgba(255, 255, 255, 0.85)', marginTop: '2px' }}>
                {doneCount} из {totalCount} выполнено
              </div>
            </div>
            <div style={{ fontSize: '18px', fontWeight: 800, color: '#ffffff' }}>{percent}%</div>
          </div>
    ...
    case '4':
      return (
        <div className={styles.variant4}>
          <div>
            <div style={{ fontSize: '14.5px', fontWeight: 700, color: '#ffffff' }}>{titleText}</div>
            <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.85)' }}>Прогресс дня: {doneCount} из {totalCount}</div>
            <div className={styles.v4BarContainer}>
              <div style={{ height: '100%', width: `${percent}%`, background: '#ffffff', borderRadius: '3px' }} />
            </div>
          </div>
          <div className={styles.v4Pill} style={{ background: '#ffffff', color: 'var(--color-accent)' }}>{percent}%</div>
        </div>
      );
      ...
      return (
        <div className={styles.variant5}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ fontSize: '20px', fontWeight: 800, color: '#ffffff' }}>{percent}%</div>
          </div>
          <div className={styles.v5Track}>
            <div className={styles.v5Fill} style={{ width: `${percent}%`, background: '#ffffff' }} />
          </div>
        </div>
      );
      ...
      return (
        <div className={styles.variant6}>
          ...
          <div className={styles.v6Right}>
            <div style={{ fontSize: '14px', fontWeight: 700, color: '#ffffff' }}>{titleText}</div>
            <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.85)' }}>
              {doneCount} из {totalCount} ({percent}%)
            </div>
            <div style={{ width: '100%', height: '5px', background: 'rgba(255,255,255,0.25)', borderRadius: '3px', overflow: 'hidden' }}>
              <div style={{ width: `${percent}%`, height: '100%', background: '#ffffff', borderRadius: '3px' }} />
            </div>
          </div>
        </div>
      );
    ...
    case '7':
      return (
        <div className={styles.variant7}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: '13.5px', fontWeight: 700, color: '#ffffff' }}>⚡ {titleText}</span>
            <span style={{ fontSize: '12px', fontWeight: 700, color: '#ffffff' }}>{percent}% XP</span>
          </div>
          <div className={styles.v7XpTrack}>
            <div className={styles.v7XpFill} style={{ width: `${percent}%`, background: '#ffffff' }} />
          </div>
          <div style={{ fontSize: '11px', color: 'rgba(255, 255, 255, 0.85)', textAlign: 'right' }}>
      ...
      return (
        <div className={styles.variant8}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <div style={{ fontSize: '16px', fontWeight: 800, color: '#ffffff' }}>{percent}%</div>
          </div>
          <div className={styles.v8BottomLine} style={{ width: `${percent}%`, background: '#ffffff' }} />
        </div>
      );
    ...
    case '9':
      return (
        <div className={styles.variant9}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ fontSize: '14.5px', fontWeight: 700, color: '#ffffff' }}>{titleText}</div>
            <div style={{ fontSize: '13px', fontWeight: 700, color: '#ffffff' }}>{percent}%</div>
          </div>
          <div className={styles.v9Row}>
            <span style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.85)', whiteSpace: 'nowrap' }}>
              {doneCount} / {totalCount} задач
            </span>
            <div className={styles.v9Track}>
              <div className={styles.v9Fill} style={{ width: `${percent}%`, background: '#ffffff' }} />
            </div>
          </div>
        </div>
      );
    ...
    default:
      return (
        <div className={styles.variant3}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ fontSize: '14.5px', fontWeight: 700, color: '#ffffff' }}>{titleText}</div>
            <div style={{ fontSize: '12px', color: 'rgba(255, 255, 255, 0.85)' }}>{doneCount} из {totalCount}</div>
          </div>
