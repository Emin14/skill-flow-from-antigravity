...
const renderParentPath = (path: Task[], variant: number = 4, catColor: string) => {
  ...
  switch (variant) {
        ...
        <div style={{ fontSize: '11px', color: 'var(--color-text-muted)', display: 'inline-flex', alignItems: 'center', gap: '4px', marginBottom: '3px', width: 'fit-content', maxWidth: '100%' }}>
          ...
          {path.map((p, idx) => (
            <React.Fragment key={p.id}>
              ...
              <span style={{ fontWeight: 400, color: idx === path.length - 1 ? 'var(--color-accent-text)' : 'inherit', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                {p.title}
              </span>
            </React.Fragment>
          ))}
    ...
    case 2:
      return (
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '2px 8px', borderRadius: '6px', background: 'var(--color-surface)', border: `1px solid ${catColor}50`, fontSize: '10.5px', fontFamily: 'monospace', color: 'var(--color-text-primary)', fontWeight: 400, marginBottom: '4px', width: 'fit-content', maxWidth: '100%', boxShadow: `0 0 10px ${catColor}20` }}>
    ...
    case 3:
      return (
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '2px 8px', borderRadius: '12px', background: 'var(--color-surface-hover)', border: '1px solid var(--color-border)', fontSize: '10.5px', color: 'var(--color-text-primary)', fontWeight: 400, marginBottom: '4px', width: 'fit-content', maxWidth: '100%' }}>
    ...
    case 4:
      return (
        <div style={{ fontSize: '11px', color: 'var(--color-accent-text)', fontWeight: 400, display: 'inline-flex', alignItems: 'center', gap: '3px', marginBottom: '3px', width: 'fit-content', maxWidth: '100%' }}>
    ...
    case 5:
      return (
        <div style={{ borderLeft: `3px solid ${catColor}`, paddingLeft: '8px', marginBottom: '4px', display: 'inline-flex', alignItems: 'center', gap: '5px', fontSize: '11px', color: 'var(--color-text-secondary)', width: 'fit-content', maxWidth: '100%' }}>
          ...
          <span style={{ fontWeight: 400, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{path.map((t) => t.title).join('  ▸  ')}</span>
        </div>
      );

    case 6:
      return (
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '3px 10px', background: 'var(--color-surface-hover)', backdropFilter: 'blur(8px)', border: '1px solid var(--color-border)', borderRadius: '12px', fontSize: '10.5px', color: 'var(--color-accent-text)', fontWeight: 400, marginBottom: '4px', width: 'fit-content', maxWidth: '100%' }}>
          <span style={{ flexShrink: 0 }}>⚡</span>
          <span style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{pathStr}</span>
        </div>
      );
    ...
    case 7:
      return (
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', padding: '2px 8px', borderRadius: '6px', background: 'var(--color-surface)', border: '1px solid var(--color-border)', fontSize: '10.5px', color: 'var(--color-accent-text)', fontWeight: 400, marginBottom: '4px', width: 'fit-content', maxWidth: '100%' }}>
    ...
    case 8:
      return (
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '5px', padding: '2px 8px', borderRadius: '10px', background: `linear-gradient(90deg, ${catColor}30, transparent)`, borderLeft: `3px solid ${catColor}`, fontSize: '10.5px', color: 'var(--color-text-primary)', fontWeight: 400, marginBottom: '4px', width: 'fit-content', maxWidth: '100%' }}>
    ...
    case 9:
      return (
        <div style={{ fontSize: '11px', color: 'var(--color-text-muted)', display: 'inline-flex', alignItems: 'center', gap: '4px', marginBottom: '3px', width: 'fit-content', maxWidth: '100%' }}>
          ...
          <span style={{ fontWeight: 400, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{pathStr}</span>
        </div>
      );
    ...
    default:
      return (
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '11px', color: 'var(--color-accent-text)', fontWeight: 400, cursor: 'pointer', marginBottom: '3px', width: 'fit-content', maxWidth: '100%' }}>
          <span style={{ flexShrink: 0 }}>🌿</span>
              ...
              <div className={styles.metaRow}>
                ...
                {formattedLink && (
                  <a
                    ...
                    style={{ display: 'inline-flex', alignItems: 'center', color: 'var(--color-accent-text)', marginLeft: '4px' }}
