...
/**
 * Variant 19: Two-Row Big Word + Pronunciation Action Strip
 */
export const Variant19InteractiveStudyCard: React.FC<BaseWordCardProps> = ({
  currentCard,
  meaningsList,
  safeMeaningIndex,
  currentMeaning,
  ...
  return (
    ...
    >
      {/* 1. Headword Header (Variation 19: Two-Row Big Word + Pronunciation Action Strip) */}
      <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
        <div style={{ fontSize: '30px', fontWeight: 800, color: '#09090b', letterSpacing: '-0.5px', lineHeight: 1 }}>
          {currentCard.word}
        </div>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span style={{ fontSize: '14px', color: '#71717a', fontFamily: 'serif' }}>
            /{displayTranscription}/
          </span>
          <button
            type="button"
