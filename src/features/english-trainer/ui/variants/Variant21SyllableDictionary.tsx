...
/**
 * Variant 21: Formal Lexical Dictionary Format with Brackets
 */
export const Variant21SyllableDictionary: React.FC<BaseWordCardProps> = ({
  currentCard,
  meaningsList,
  safeMeaningIndex,
  currentMeaning,
  ...
  return (
    ...
    >
      {/* 1. Headword Header (Variation 21: Formal Lexical Dictionary Format with Brackets) */}
      <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', gap: '10px' }}>
          <span style={{ fontSize: '30px', fontWeight: 800, color: '#0f172a', letterSpacing: '-0.3px', lineHeight: 1 }}>
            {currentCard.word}
          </span>
          <span style={{ fontSize: '14.5px', color: '#475569', fontWeight: 500, fontFamily: 'serif' }}>
            [ /{displayTranscription}/ ]
          </span>
        </div>
        <button
