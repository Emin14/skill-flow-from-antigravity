...
/**
 * Variant 12: Centered Hero Word + Subtitle IPA & Speaker
 */
export const Variant12PillStepperGlow: React.FC<BaseWordCardProps> = ({
  currentCard,
  meaningsList,
  safeMeaningIndex,
  currentMeaning,
  ...
  return (
    ...
    >
      {/* 1. Headword Header (Variation 12: Centered Hero Word + Subtitle IPA & Speaker) */}
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '1px' }}>
        <span style={{ fontSize: '32px', fontWeight: 800, color: '#09090b', letterSpacing: '-0.5px', lineHeight: 1.1, textAlign: 'center' }}>
          {currentCard.word}
        </span>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          <span style={{ fontSize: '14.5px', color: '#71717a', fontFamily: 'serif' }}>
            /{displayTranscription}/
          </span>
          <button
            type="button"
