...
/**
 * Variant 17: Centered Word + Full Interactive Pronunciation Bar [ 🔊 /{IPA}/ ]
 */
export const Variant17AccordionInspector: React.FC<BaseWordCardProps> = ({
  currentCard,
  meaningsList,
  safeMeaningIndex,
  currentMeaning,
  ...
  return (
    ...
    >
      {/* 1. Headword Header (Variation 17: Centered Word + Full Interactive Pronunciation Bar [ 🔊 /{IPA}/ ]) */}
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
        <span style={{ fontSize: '30px', fontWeight: 800, color: '#09090b', letterSpacing: '-0.5px', lineHeight: 1 }}>
          {currentCard.word}
        </span>
        <button
          type="button"
        ...
        >
          ...
          <span style={{ fontFamily: 'serif' }}>/{displayTranscription}/</span>
        </button>
      </div>
