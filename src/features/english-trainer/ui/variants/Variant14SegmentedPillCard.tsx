...
/**
 * Variant 3: Master Layout with Horizontal Meaning Pills Track + Side Quick-Switch Arrows [‹] [›]
 */
export const Variant14SegmentedPillCard: React.FC<BaseWordCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* 3. Horizontal Meaning Pills Track with Side Quick-Switch Arrows [‹] [›] */}
      <div
        style={{
          height: '26px',
          minHeight: '26px',
      ...
      >
        ...
        >
          ...
          {/* Spacer so the last pill is never clipped against the right border */}
          <span style={{ width: '4px', flexShrink: 0, display: 'inline-block' }} />
        </div>

        {/* ALWAYS VISIBLE PINNED Expander Pill at the Right Edge */}
