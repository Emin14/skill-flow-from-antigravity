...
/**
 * Variant 20: Floating Corner Audio Ring & Status Dot
 */
export const Variant20UltimateLexicalPro: React.FC<BaseWordCardProps> = ({
  currentCard,
  meaningsList,
  safeMeaningIndex,
  currentMeaning,
  ...
  return (
    ...
    >
      {/* 1. Headword Header (Variation 20: Floating Corner Audio Ring & Status Dot) */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <span style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#2563eb', display: 'inline-block', boxShadow: '0 0 6px rgba(37,99,235,0.6)' }} />
          <span style={{ fontSize: '29px', fontWeight: 800, color: '#09090b', letterSpacing: '-0.4px', lineHeight: 1 }}>
            {currentCard.word}
          </span>
          <span style={{ fontSize: '14.5px', color: '#71717a', fontStyle: 'italic', fontFamily: 'serif' }}>
            /{displayTranscription}/
          </span>
        </div>
        <button
