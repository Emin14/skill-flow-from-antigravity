# -*- coding: utf-8 -*-
"""
Perfect slot-based injection for all Oxford homonym entries.
"""
import json, sys
...
# Counters for stateful replacement
count_house = 0
count_it = 0
count_live = 0
count_march = 0
...
for item in oxford_data:
    ...
    if w.lower() == 'house':
        if count_house == 0:
            final_list.append(ENTRY_HOUSE_NOUN)
        else:
            final_list.append(ENTRY_HOUSE_VERB)
        count_house += 1
    elif w.lower() == 'it':
        if count_it == 0:
            final_list.append(ENTRY_IT_NOUN)
        else:
            final_list.append(ENTRY_IT_PRONOUN)
        count_it += 1
    elif w.lower() == 'live':
        if count_live == 0:
            final_list.append(ENTRY_LIVE_VERB)
        elif count_live == 1:
            final_list.append(ENTRY_LIVE_ADJ)
        else:
            final_list.append(ENTRY_LIVE_ADV)
        count_live += 1
    elif w.lower() == 'march':
        if count_march == 0:
            final_list.append(ENTRY_MARCH_NOUN)
        else:
            final_list.append(ENTRY_MARCH_VERB_NOUN)
        count_march += 1
    elif w.lower() == 'may':
        if count_may == 0:
            final_list.append(ENTRY_MAY_NOUN)
        else:
            final_list.append(ENTRY_MAY_MODAL)
        count_may += 1
    elif w.lower() == 'minute':
        if count_minute == 0:
            final_list.append(ENTRY_MINUTE_NOUN)
        else:
            final_list.append(ENTRY_MINUTE_ADJ)
        count_minute += 1
    elif w.lower() == 'use':
        if count_use == 0:
            final_list.append(ENTRY_USE_VERB)
        else:
            final_list.append(ENTRY_USE_NOUN)
        count_use += 1
    elif w == 'wind1':
        final_list.append(ENTRY_WIND1_NOUN)
    elif w == 'wind2':
        final_list.append(ENTRY_WIND2_VERB)
    else:
        final_list.append(item)

print(f"Final dataset built: {len(final_list)} items!")
