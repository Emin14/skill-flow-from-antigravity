...
print("=== Running Comprehensive Verification and Quality Inspection ===")
...
print(f"Total core meanings: {total_meanings}")
print(f"Total examples: {total_examples}")
print(f"Total idioms & phrasal verbs in phrases: {total_phrases}")
...
print("\n--- Inspecting 'cross' in verified dataset ---")
cross_item = next(item for item in data if item['word'] == 'cross')
print(json.dumps(cross_item, ensure_ascii=False, indent=2))
