...
for p in range(14, 924):
    ...
    for col_idx in range(3):
        ...
        for l in col_lines:
            ...
            # Filter out single-letter section headers like "A", "B", "C" with large size or alone on line
            ...
            if is_hw:
                ...
                # Check for homonym marker attached in second span e.g. "I", "II" in bold or normal
                # after headword before transcription
...
doc.close()
t1 = time.time()
print(f"Extracted {len(articles)} articles across pages 15-924 in {t1 - t0:.2f}s!")

# Check first and last 5 articles
print("\nFirst 5 articles:")
for a in articles[:5]:
    print(f"  {a['headword']} (p.{a['page']}) -> {a['text'][:100]}...")
